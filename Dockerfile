...
# INSTALL SOFTWARE
RUN apk add --update openldap=${LDAP_VERSION} openldap-clients openldap-back-hdb openldap-overlay-memberof openldap-overlay-refint openldap-overlay-unique openldap-overlay-ppolicy\
 && rm -rf /var/cache/apk/* \
