...
### Security
- [#94] Set the LDAP root DN password on every start.
  - This password may have been generated by a `doguctl` version generating an unsafe password
  - CES users and service accounts are unaffected.
